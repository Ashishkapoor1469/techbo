...
const mockPackagesData: Package[] = [
  {
    ...
    logoUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT30YZ6OxUYmrkohkH5iLGg2eIdN2rgWi9sJA&s',
...
module.exports = {
  ...
  },
  {
    ...
    logoUrl: 'https://media.licdn.com/dms/image/sync/v2/D5627AQF5Bhn-We-FKQ/articleshare-shrink_1280_800/B56ZTyvOdpGoAY-/0/1739239254109?e=2147483647&v=beta&t=ksRzZJLPyojGN1b50e7dw0fjShNNLkta6Hez3wGcNHY',
...
function MyComponent() {
  ...
  },
  {
    ...
    logoUrl: 'https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F586mad38xtg6a3v6ixkr.png',
    dataAiHint: 'zod logo',
    version: '3.23',
...
try {
  ...
  },
  {
    ...
    logoUrl: 'https://avatars.githubusercontent.com/u/66879934?v=4',
